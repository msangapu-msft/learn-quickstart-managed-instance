...
@description('Storage account name containing scripts.zip.')
param storageAccountName string

@description('Blob container name containing scripts.zip.')
...
var installScriptBlobUri = 'https://${storageAccountName}.blob.${environment().suffixes.storage}/${containerName}/scripts.zip'
